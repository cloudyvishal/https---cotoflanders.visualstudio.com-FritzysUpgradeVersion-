<%@ Application Language="C#" Inherits="CyberSource.Client.Global1" Codebehind="Global.asax.cs" %>
...
<script runat="server">
    ...
    //{
    //    Session["GroomerUserName"] = Session["GroomerUserName"];
    //    Session["GId"] = Session["GId"];
