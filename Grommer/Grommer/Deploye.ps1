...
if(-not ($Env:BUILD_SOURCESDIRECTORY -and $Env:BUILD_BUILDNUMBER))
{
    ...
    Write-Host '$Env:BUILD_SOURCESDIRECTORY - D:\EdCode\FritzysFrmdharneProjectVII\Web Application Code\Code\Grommer\Grommer'
    Write-Host '$Env:BUILD_SOURCESDIRECTORY = "D:\EdCode\FritzysFrmdharneProjectVII\Web Application Code\Code\Grommer\Grommer"'
...
$files = gci $Env:BUILD_SOURCESDIRECTORY -recurse -include "*Properties*","Grommer" | 
    ?{ $_.PSIsContainer } | 
