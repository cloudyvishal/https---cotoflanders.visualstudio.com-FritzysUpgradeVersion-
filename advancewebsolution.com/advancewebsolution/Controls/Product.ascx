<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_Product" Codebehind="Product.ascx.cs" %>
            ...
            <div class="innerPannelLeft">
                ...
                <div class="right">
                    ...
                    <a href="Contactus.aspx" title="Buy">
                        <img src="http://fritziespetcarepros.com//images/btn_buy.gif" width="53" height="20"
                            alt="Buy" />
                    </a>
                </div>
            </div>
