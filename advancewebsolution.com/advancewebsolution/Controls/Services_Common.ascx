<%@ Control Language="C#" AutoEventWireup="true"  Inherits="Services_Common" Codebehind="Services_Common.ascx.cs" %>
            ...
            <asp:UpdatePanel ID="up2" runat="server">
                <ContentTemplate>
                    ...
                    <div class="prevNext" id="divprevNext" runat="server">
                        <ul>
                            <li>
                                <asp:LinkButton ID="lnkPrev" runat="server" Text="Previous" OnClick="lnkPrev_Click" ToolTip="Previous" CssClass="prevlink"></asp:LinkButton></li>
                            <li>
                                <asp:Label ID="lblDivider" runat="server" Text="|"></asp:Label>
                            </li>
                            <li>
                                <asp:LinkButton ID="lnkNext" runat="server" Text="Next" OnClick="lnkNext_Click" ToolTip="Next" CssClass="prevlink"></asp:LinkButton></li>
                        </ul>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
