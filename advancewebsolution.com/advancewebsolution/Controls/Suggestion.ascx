<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_Suggestion" Codebehind="Suggestion.ascx.cs" %>
...
<cc1:ModalPopupExtender ID="ModalPopupExtender5" runat="server" TargetControlID="btnSuggestion" BehaviorID="SuggestionBox"
                                ...
                                <div id="divsuggestn">
                                    <table width="100%" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtEmail" runat="server" CssClass="textField" ValidationGroup="valSuggest1"
