<%@ Page Language="C#" MasterPageFile="Inner_Page_MB_MasterPage.master" AutoEventWireup="true"
    ...
    Inherits="MB_appointment_registration" Title="Mobile Grooming Services" Codebehind="MB_appointment_registration.aspx.cs" %>
    ...
    <div class="contentinnersection">
        ...
        <div class="innercontent">
            ...
            <div class="forform">
                ...
                <asp:Button ID="imgAddmore" CssClass="button" runat="server" Text="Add More Pet"
                ...
                <asp:TextBox CssClass="txtbox" ID="txtEmailReg" runat="server"></asp:TextBox><br />
