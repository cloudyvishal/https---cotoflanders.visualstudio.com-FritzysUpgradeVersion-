...
public partial class Dog_and_Pet_Blueberry_Facial : System.Web.UI.Page
{
    int ServiceId = 77;
    int pageid = 1;
	...
	int Count = 0;
        ...
        if (!IsPostBack)
        {
            ...
            {
                 Response.Redirect("http://fritziespetcarepros.com//mobileweb/Dog_and_Pet_Blueberry_Facial.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Dog_and_Pet_Blueberry_Facial.aspx"));
