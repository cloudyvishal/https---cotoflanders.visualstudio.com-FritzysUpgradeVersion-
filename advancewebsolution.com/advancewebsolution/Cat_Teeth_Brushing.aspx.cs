...
public partial class Cat_Teeth_Brushing : System.Web.UI.Page
{
    //need to set;
	int ServiceId = 39;
    int pageid = 1;
	...
	int Count = 0;
        ...
        if (!IsPostBack)
        {
            ...
            {
                 Response.Redirect("http://fritziespetcarepros.com//mobileweb/Cat_Teeth_Brushing.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Cat_Teeth_Brushing.aspx"));
