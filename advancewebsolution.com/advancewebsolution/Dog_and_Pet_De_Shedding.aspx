<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" Inherits="Dog_and_Pet_De_Shedding" Codebehind="Dog_and_Pet_De_Shedding.aspx.cs" %>
          ...
          <script type="text/javascript">
                ...
                // ]]>
                        ...
                        <div class="ServicesDatalistDiv">
                            ...
                            <div class="title">
                                <%--<asp:Image ID="blanktitle" ImageUrl="~/Images/pageTitle.jpg" runat="server" AlternateText=""/>--%></div>
                            <div class="backlinkDiv">
                                <a class="servbacklink" href="javascript: window.history.back()">Go Back</a><%-- <asp:HyperLink ID="hypBack" runat="server" Text="Back to Services" CssClass="servbacklink" OnClick=""
                                <asp:LinkButton ID="lnkBack" runat="server" Text="Back to Services" CssClass="servbacklink" OnClientClick="history.back();" ></asp:LinkButton>--%></div>
                            <%-- <div class="left1">
