...
public partial class Dog_and_Pet_Flea_and_Tick : System.Web.UI.Page
{
    int ServiceId = 40;
    int pageid = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                 Response.Redirect("http://fritziespetcarepros.com/mobileweb/Dog_and_Pet_Flea_and_Tick.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com/", "http://fritziespetcarepros.com/Dog_and_Pet_Flea_and_Tick.aspx"));
