...
if(-not ($Env:BUILD_SOURCESDIRECTORY -and $Env:BUILD_BUILDNUMBER))
{
    ...
    Write-Host '$Env:BUILD_SOURCESDIRECTORY - D:\EdCode\FritzysFrmdharneProjectVII\Web Application Code\Code\advancewebsolution.com\advancewebsolution'
    Write-Host '$Env:BUILD_SOURCESDIRECTORY = "D:\EdCode\FritzysFrmdharneProjectVII\Web Application Code\Code\advancewebsolution.com\advancewebsolution"'
...
$files = gci $Env:BUILD_SOURCESDIRECTORY -recurse -include "*Properties*","advancewebsolution" | 
    ?{ $_.PSIsContainer } | 
