...
public partial class Cat_SuperBowl : System.Web.UI.Page
{
    int ServiceId = 82;
    int pageid = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                  Response.Redirect("http://fritziespetcarepros.com//mobileweb/Cat_SuperBowl.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Cat_SuperBowl.aspx"));
