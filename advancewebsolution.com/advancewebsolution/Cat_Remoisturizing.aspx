<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" Inherits="Cat_Remoisturizing" Codebehind="Cat_Remoisturizing.aspx.cs" %>
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="flashImg">
                            ...
                            <asp:LinkButton ToolTip="Click for Coupon." runat="server" ID="lnkHoverBanner"> <asp:PlaceHolder ID="plh" runat="server"></asp:PlaceHolder>
                            </asp:LinkButton>
