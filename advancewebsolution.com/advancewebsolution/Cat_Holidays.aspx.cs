...
public partial class DCat_Holidays : System.Web.UI.Page
{
    int ServiceId = 81;
    int pageid = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("http://fritziespetcarepros.com//mobileweb/Cat_Holidays.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Cat_Holidays.aspx"));
