<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" Inherits="FleaTick" Title="Flea, Tick and Hot Spot" Codebehind="FleaTick.aspx.cs" %>
                        ...
                        <div class="HomeleftInner">
                            <div class="innerPannelLeft">
                                <div class="innerTitle">
                                    <img src="images/for_your_dogs_title.jpg" alt="Flea Treatment, Tick Treatment" />
                                </div>
                                <div class="left1">
                            ...
                            <div class="innerPannelRight">
                                <div class="innerTitle">
                                    <asp:Image ID="forcats" ImageUrl="~/images/for_your_cats_title.jpg" runat="server" AlternateText="Flea Treatment, Tick Treatment" />
                                </div>
