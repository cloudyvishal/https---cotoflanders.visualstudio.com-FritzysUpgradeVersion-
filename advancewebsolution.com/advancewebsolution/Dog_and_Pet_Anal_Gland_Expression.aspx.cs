...
public partial class Dog_and_Pet_Anal_Gland_Expression : System.Web.UI.Page
{
    int ServiceId = 50;
    int pageid = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        plh.Controls.Add(new LiteralControl(plyr));
            ...
            {
                Response.Redirect("http://fritziespetcarepros.com//mobileweb/Dog_and_Pet_Anal_Gland_Expression.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Dog_and_Pet_Anal_Gland_Expression.aspx"));
