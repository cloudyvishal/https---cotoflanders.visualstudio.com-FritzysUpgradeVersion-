<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    Inherits="FritzyFriends" Title="Fritzy's pet care pros : Fritzy Friends" Codebehind="FritzyFriends.aspx.cs" %>
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="title">
                            <asp:Image ID="fritzyfriendtitle" ImageUrl="~/Images/fritzyfriendTitle.jpg" runat="server"
                                AlternateText="" />
                        </div>
                        <div class="leftInner">
                            <div class="aboutinnerleft">
                                <asp:Image ID="leftimage" ImageUrl="~/Images/fritzyfriendleft.jpg" runat="server"
                                    AlternateText="" />
                            </div>
