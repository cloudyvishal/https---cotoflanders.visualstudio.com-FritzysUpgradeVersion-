...
public partial class Cat_ValentinesDay : System.Web.UI.Page
{
    int ServiceId = 80;
    int pageid = 1;
	...
	int Count = 0;
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("http://fritziespetcarepros.com//mobileweb/Cat_ValentinesDay.aspx".ToLower());
				HttpContext.Current.Response.Status = "301 Moved Permanently";
                HttpContext.Current.Response.AddHeader("Location",Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Cat_ValentinesDay.aspx"));
