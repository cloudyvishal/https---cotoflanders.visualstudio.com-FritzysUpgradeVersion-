...
using advancewebtosolution.BO;
    ...
    public partial class Cat_BrushOut : System.Web.UI.Page
    {
        int ServiceId = 70;
        int pageid = 1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("http://fritziespetcarepros.com//mobileweb/Cat_BrushOut.aspx".ToLower());
                    HttpContext.Current.Response.Status = "301 Moved Permanently";
                    HttpContext.Current.Response.AddHeader("Location", Request.Url.ToString().Replace("http://fritziespetcarepros.com//", "http://fritziespetcarepros.com//mobileweb/Cat_BrushOut.aspx"));
