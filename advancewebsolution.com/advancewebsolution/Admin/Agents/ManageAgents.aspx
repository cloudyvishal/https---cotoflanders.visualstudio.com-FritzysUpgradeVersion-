<%@ Page Title="Admin - Manage Agents" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" Inherits="Admin_Agents_ManageAgents" Codebehind="ManageAgents.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="innerContent">
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add Agent" CssClass="btnBg" ToolTip="Add Agent"
            PostBackUrl="~/Admin/Agents/AddAgent.aspx" />
