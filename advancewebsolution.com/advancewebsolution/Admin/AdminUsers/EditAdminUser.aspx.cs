...
public partial class Admin_Users_EditAdminUser : System.Web.UI.Page
{
    #region
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            User ObjUser = new User();
            int Count = ObjUser.UpdateAdminUser(int.Parse(Request.QueryString["UserID"]), txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtUserName.Text.Trim(), txtPassword.Text.Trim(), txtEmail.Text.Trim(), txtPhone.Text.Trim(), txtAddress1.Text.Trim(), txtAddress2.Text.Trim(), 0);
            SuccesfullMessage("Admin updated successfully");
        }
        catch  { }
    }
}
