<%@ Page Title="Admin - Manage Manager" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" Inherits="Admin_Manager_ManageManager" Codebehind="ManageManager.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="innerContent">
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add Manager" CssClass="btnBg" ToolTip="Add Manager"
            PostBackUrl="~/Admin/Manager/AddManager.aspx" />
        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnBg" ToolTip="Detlete"
            OnClick="btnDelete_Click" />
        <asp:Button ID="btnStatus" runat="server" Text="Active/Inactive" CssClass="btnBg"  ToolTip="Active/Inactive" OnClick="btnStatus_Click" />
        <%--region button end  --%>
