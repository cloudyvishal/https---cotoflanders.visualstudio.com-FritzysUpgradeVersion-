<%@ Page Title="Admin - Edit Manager" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" Inherits="Admin_Manager_EditManager" Codebehind="EditManager.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="innerContent">
        ...
        <asp:Button ID="btnBack" runat="server" CssClass="btnBg" Text="Cancel" ToolTip="Cancel"
            CausesValidation="false" PostBackUrl="~/Admin/Manager/ManageManager.aspx?SearchFor=0&SearchText=" />
    </div>
</asp:Content>
