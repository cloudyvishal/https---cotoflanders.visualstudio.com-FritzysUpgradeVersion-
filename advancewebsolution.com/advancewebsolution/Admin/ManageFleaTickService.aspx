<%@ Page Title="Admin - Flea & Tick Page Services" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" Inherits="Admin_ManageFleaTickService" Codebehind="ManageFleaTickService.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="innerContent">
        <div class="pageTitle">
            <h2>
                Manage Flea & Tick Page Services</h2>
        </div>
