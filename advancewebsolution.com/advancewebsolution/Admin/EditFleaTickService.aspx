<%@ Page Title="Admin - Edit Flea and Tick page Service" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" Inherits="Admin_EditFleaTickService" Codebehind="EditFleaTickService.aspx.cs" %>
...
<script type="text/javascript" language="javascript" >
    ...
    <div class="innerContent">
        <div class="pageTitle">
            <h2>
                Edit Flea and Tick page Service </h2>
        </div>
