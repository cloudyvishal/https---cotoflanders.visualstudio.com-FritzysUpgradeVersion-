...
public partial class SetService : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        ds = ObjServices.GetAllHomeServices();
    ...
    protected void btnRemove_Click(object sender, EventArgs e)
    {
        for (int i = 0; i <= GrdServiceHome.Rows.Count - 1; i++)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    ObjServices.UpdateIsHome(Convert.ToInt32(lblServiceID.Text), 0);
                    ViewState["Cat"] = "False";
                }
                else
                {
                    ObjServices.UpdateIsHome(Convert.ToInt32(lblServiceID.Text), 1);
                    ViewState["Dog"] = "False";
                }
            }
        }
    ...
    protected void btnDog_Click(object sender, EventArgs e)
    {
        ...
        {
            ObjServices.SetService(Convert.ToInt32(ddlDog.SelectedValue));
            ViewState["Dog"] = "True";
    ...
    protected void btnCat_Click(object sender, EventArgs e)
    {
        ...
        {
            ObjServices.SetService(Convert.ToInt32(ddlCat.SelectedValue));
            ViewState["Cat"] = "True";
            divError.Visible = false;
