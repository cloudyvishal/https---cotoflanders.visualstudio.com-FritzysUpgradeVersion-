...
{
    public partial class Admin_Groomer_GroomersForData : System.Web.UI.Page
    {
        #region Declare
        ...
        //{
        //    Response.Redirect("GroomersForData.aspx?SearchFor=" + ddlSearch.SelectedValue + "&SearchText=" + txtSearch.Text.Trim());
        //}
        ...
        {
            Response.Redirect("GroomerDailyLogData.aspx?GID=" + ddlGroomerlist.SelectedValue);
        }
        //#region GridEvent
