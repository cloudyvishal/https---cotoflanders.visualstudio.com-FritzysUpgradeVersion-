<%@ Page Title="View Grooming Appointments" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" ValidateRequest="false" AutoEventWireup="true" Inherits="Admin_Groomer_ViewGroomerAppointment" CodeBehind="ViewGroomerAppointment.aspx.cs" %>
                            ...
                            <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Style="display: none" EnableViewState="true">
                                <table class="adduserTable" style="text-align: left" cellpadding="6" cellspacing="0">
                                    ...
                                    <tr style="display: none;">
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text="Sequence #:" Style="display: none;"></asp:Label>
                                        </td>
                                        <td>
