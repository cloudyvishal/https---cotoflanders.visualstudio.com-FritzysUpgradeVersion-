<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" ValidateRequest="false" AutoEventWireup="true" Inherits="Admin_Friends_AddFriends" Title="Admin - Add Friends" CodeBehind="AddFriends.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function ValidateURL(source, args) {
            //var regexp = /www.[A-Za-z0-9\.-]{3,}\.[A-Za-z]{3}/;
    ...
    <div class="innerContent">
        ...
        <%--Region form for add friend end --%>
        <asp:Button ID="AddUser" runat="server" Text="Add Friends" ToolTip="Add Friend" CssClass="btnBg" OnClick="AddUser_Click" />
        &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnBack" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="btnBg" CausesValidation="false" PostBackUrl="~/Admin/Friends/ManageFriends.aspx?SearchFor=0&SearchText=" />
    </div>
</asp:Content>
