<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" Inherits="Admin_Services_ServicePageServices" Title="Untitled Page" Codebehind="ServicePageServices.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="innerContent">
        <div class="pageTitle">
            <h2>
                Manage Service Page Services</h2>
        </div>
        ...
        <asp:GridView ID="GrdService" runat="server" DataKeyNames="ServiceID" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Image">
                    ...
                    <HeaderStyle CssClass="headerStyle" />
                    <ItemTemplate>
                        <img id="ImageCoupon" alt="ImageService"  src="#" runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
