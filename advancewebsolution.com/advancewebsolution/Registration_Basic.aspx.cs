...
public partial class Registration_Basic :Page
{
    public delegate void CaptchaEventHandler();
    string PetTypeID = "0";
    private string color = "#ffffff";
    protected string style;
    //event CaptchaEventHandler success;
    ...
    */
    ...
    protected void Page_Load(object sender, EventArgs e) 
    {
        if (!IsPostBack)
        {
            ...
            p6.Visible = false;
            BindState();
            litContent.Text = ContentManager.GetFileContentView(ContentManager.GetPhysicalPath(Session["HomePath"].ToString() + "StoreData/StaticeContent/Registration_Basic.htm"));
        }
    }
    ...
    protected void IdSubmit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else
        {
            ...
            {
                lblCaptchaError.Visible = true;
                lblCaptchaError.Text = "We’re sorry, this username already exists.Please Chosse Another one";
            }
        }
    }
